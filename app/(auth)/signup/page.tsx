  ...
  if (sent) {
    return (
      <div className="w-full max-w-sm text-center">
        <div className="text-accent font-mono font-bold text-xl tracking-tight mb-8" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
          match//ai
        </div>
        <div className="bg-surface border border-border rounded-xl p-8">
          ...
          <p className="text-sm text-muted">
            ...
            <span className="text-zinc-100">{email}</span>. Click it to activate your account.
          </p>
        </div>
